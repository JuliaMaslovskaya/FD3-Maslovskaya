...
,
  ...
  render: function () {
      ...
      return React.DOM.div({className: 'filter'},
          React.DOM.input({type: 'checkbox', defaultChecked: this.state.isChecked, onClick: this.checkBoxClicked}),
          React.DOM.input({type: 'text', defaultValue: this.state.curValue, onChange: this.inputChanged}),
          React.DOM.input({type: 'button', value:'Сброс', defaultValue: this.state.isclick, onClick: this.inputClick}),
